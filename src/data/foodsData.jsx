...
export const foodsData = {
    ...
    ,offer : [
        { name: "پاستا بلونز", id: 1, image: images[13], title: "اسپاگتی، گوشت چرخ کرده، هویج،", price: "160000", discount: "12", stars: 4 },
        { name: "لازانیا", id: 2, image: images[15], title: "لازانیا، قارچ، ریحان تازه، جعفری تازه، ", price: "150000", discount: "0", stars: 5 },
        { name: "میرزا قاسمی", id: 3, image: images[2], title: "بادمجان، گوجه فرنگی، تخم مرغ، سیر، رب گوجه فرنگی", price: "142000", discount: "10", stars: 5 },
        { name: "راتاتویی", id: 4, image: images[14], title: "بادمجان، گوجه فرنگی، کدو سبز، پیاز", price: "95000", discount: "45", stars: 4 },
        { name: "باقلاقاتوق", id: 5, image: images[3], title: "پاچ باقلا، شوید خشک، کره، سیر، تخم مرغ", price: "180000", discount: "30", stars: 4 },
        { name: "فلافل", id: 6, image: images[4], title: "نخود، پیاز، تخم گشنیز، سیر، جعفری، سیب زمینی", price: "80000", discount: "%35", stars: 3 },
        { name: "کله جوش", id: 7, image: images[5], title: "کشک، گردو، پیاز، نعناع خشک", price: "203000", discount: "5", stars: 4 },
        { name: "پیتزا مارگاریتا", id: 8, image: images[26], title: "گوجه فرنگی، ریحان، سیر، پنیر پیتزا", price: "147000", discount: "13", stars: 2 },
        { name: "پیتزا اسفناج", id: 9, image: images[25], title: "اسفناج تازه، پیاز، سیر، پنیر پیتزا، قارچ", price: "252000", discount: "10", stars: 5 },
        { name: "ساندویچ کتلت مخصوص", id: 10, image: images[28], title: "سیب زمینی، لوبیا قرمز،  بلغور گندم، نعناع خشک، پودر زیره، پودر جوز هندی، گوجه فرنگی، روغن زیتون", price: "205000", discount: "18", stars: 5 },
    ]
    ,popular : [
        { name: "پیتزا روکولا", id: 1, image: images[20], title: "اسفناج، سبزی روکولا، آرد، پودر مایه خمیر، روغن زیتون، خردل، سیر، پنیر موزارلا و پارمسان، گوجه گیلاسی ،سس فلفل سبز تند ", price: "188000", discount: "12", stars: 5 },
        { name: "ساندویچ سوسیس کوکتل", id: 2, image: images[29], title: "سوسیس گیاهی، پیاز، سیب زمینی،  رب گوجه فرنگی", price: "165000", discount: "35", stars: 4 },
        { name: "باقلاقاتوق", id: 3, image: images[3], title: "پاچ باقلا، شوید خشک، کره، سیر، تخم مرغ", price: "180000", discount: "30", stars: 4 },
        { name: "پالاک پنیر", id: 4, image: images[19], title: "پنیر، اسفناج، گوجه، پیاز، سیر ", price: "180000", discount: "15", stars: 4 },
        { name: "کوفته برنجی", id: 5, image: images[0], title: "برنج سبزی کوفته لپه آرد نخودچی، گردو و زرشک و آلو پیاز", price: "145000", discount: "35", stars: 5 },
        { name: "میرزا قاسمی", id: 6, image: images[2], title: "بادمجان، گوجه فرنگی، تخم مرغ، سیر، رب گوجه فرنگی", price: "142000", discount: "10", stars: 5 },
        { name: "پاکورا سبزیجات", id: 7, image: images[17], title: "گرام ماسالا، پودر کاری، سیر له شده،", price: "110000", discount: "8", stars: 4 },
        { name: "ساندویچ کتلت مخصوص", id: 8, image: images[28], title: "سیب زمینی، لوبیا قرمز،  بلغور گندم، نعناع خشک، پودر زیره، پودر جوز هندی، گوجه فرنگی، روغن زیتون", price: "205000", discount: "18", stars: 5 },
        { name: "کالزونه اسفناج", id: 9, image: images[18], title: "اسفناج، قارچ، پنیر موزارلا یا پنیر ", price: "177000", discount: "17", stars: 5 },
        { name: "کشک بادمجان", id: 10, image: images[1], title: "بادمجان، کشک، نعناع خشک، مغز گردو، سیر، پیاز", price: "95000", discount: "0", stars: 5 },
        { name: "سوشی", id: 11, image: images[16], title: "جلبک دریایی/ نوری، برنج کته، سرکه ", price: "85000", discount: "15", stars: 4 },
        { name: "پیتزا بادمجان و زیتون", id: 12, image: images[21], title: "بادمجان کوچک، روغن زیتون، پنیر موزارلا، پنیر پارمزان، برگ ریحان، گوجه فرنگی، سس گوجه فرنگی", price: "150000", discount: "0", stars: 4 },
        { name: "پیتزا سبزیجات و خامه", id: 13, image: images[22], title: "نخود فرنگی پخته شده، ذرت نیم پز، فلفل دلمه‌ای رنگی، قارچ، سیر یا پیازچه خردشده", price: "185000", discount: "21", stars: 4 },
        { name: "ساندویچ کتلت کدو سبز", id: 14, image: images[30], title: "کدو سبز، هویج، سیب زمینی، پیاز", price: "145000", discount: "0", stars: 5 },
        { name: "پنینی اسفناج", id: 15, image: images[31], title: " قارچ، اسفناج، پیاز، پنیر پیتزا، خامه، پودر پاپریکا، گردو، سرکه بالزامیک، سس مایونز", price: "190000", discount: "15", stars: 3 },
        { name: "ساندویچ سوسیس کوکتل", id: 16, image: images[29], title: "سوسیس گیاهی، پیاز، سیب زمینی،  رب گوجه فرنگی", price: "165000", discount: "35", stars: 4 },
